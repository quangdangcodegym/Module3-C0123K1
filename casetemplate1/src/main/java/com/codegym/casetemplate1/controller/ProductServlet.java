package com.codegym.casetemplate1.controller;
...
import com.codegym.casetemplate1.service.CategoryServiceImpl;
import com.codegym.casetemplate1.service.ICategoryService;
import com.codegym.casetemplate1.service.IProductService;
import com.codegym.casetemplate1.service.ProductServiceImpl;
import com.codegym.casetemplate1.utils.ValidateUtils;
...
public class ProductServlet extends HttpServlet {
    ...
    private void showAddProduct(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = req.getRequestDispatcher(AppUtils.VIEW_ADMIN_PATH + "product/create.jsp");
    ...
    private void showProducts(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = req.getRequestDispatcher(AppUtils.VIEW_ADMIN_PATH + "product/list.jsp");
        requestDispatcher.forward(req, resp);
    }
